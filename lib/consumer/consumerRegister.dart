...
import 'package:unavu_new/flogin/fotp.dart';
...
class ConsumerRegister extends StatefulWidget {
  ConsumerRegister({Key key, this.title}) : super(key: key);
  ...
  Widget _emailPasswordWidget() {
    return Column(
      children: <Widget>[
        _entryName("Name"),
        _entryPhonenum(
            "Phone Number"), //Create a new widget and include google maps
        _entryPlace("Place"),
      ],
    );
  }
